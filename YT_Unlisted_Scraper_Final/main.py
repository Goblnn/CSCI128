...
# READ THE README BEFORE RUNNING
...
if __name__ == "__main__":
    ...
    if(init_from_file == "Y"):
        ...
        if(ready_to_continue == "STOP"):
            ...
            with open("LastURL.txt","r") as init_file:
    ...
    while(True):
        ...
        video_type = func.check_for_unlisted(cur_URL, cur_ID)

        if(video_type == "Unlisted"):
            with open("UnlistedVideos.txt","a") as unlisted_videos:
            ...
            with open("PublicVideos.txt","a") as unlisted_videos:
                unlisted_videos.write(cur_URL + "\n")
    ...
    with open("TotalURLsTested.txt","r") as total_tested_file:
        total_tested = int(total_tested_file.readline().strip("\n"))
        total_tested += URLs_tested

    with open("TotalURLsTested.txt","w") as total_tested_file:
